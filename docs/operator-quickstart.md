# Operator Quickstart — Other sports activities

Shortest path from clone to a verified local dry-run for **ISIC 9319** (`cloud-itonami-isic-9319`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-9319.git
cd cloud-itonami-isic-9319
```
...
- Blueprint governor key: `event-integrity-governor`
- Likely source path: `sportsevent.governor.cljc`
